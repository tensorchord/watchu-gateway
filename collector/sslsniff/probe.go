...
func NewSSLProbe(sslPath, rustlsPath *string, scanHostProc bool, client *export.GatewayClient) *SSLProbe {
...
func (sp *SSLProbe) Start(ctx context.Context) {
	...
	go container.NewContainerLibsDetector(sp.scanHostProc).Start(ctx, channel)
